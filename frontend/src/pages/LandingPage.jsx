      ...
      <div className="backdrop-brightness-50">
        <div className="mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-6 py-20">
          <div className="max-w-3xl space-y-8">
            <p className="text-sm uppercase tracking-[0.5em] text-accent-emerald">AI interview training</p>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              <Link to="/register" className="inline-flex items-center justify-center rounded-3xl bg-gradient-to-r from-accent-violet to-accent-emerald px-8 py-4 text-sm font-semibold text-white transition hover:brightness-110">
                Get started
              </Link>
              <Link to="/login" className="inline-flex items-center justify-center rounded-3xl border border-white/20 bg-white/5 px-8 py-4 text-sm font-semibold text-white transition hover:bg-white/10">
                Sign in
              </Link>
            </div>
          </div>
